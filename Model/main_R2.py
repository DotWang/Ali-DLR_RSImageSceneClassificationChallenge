...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_yous1_dehaze_fold2')
...
trn_idx=fold_idx[1][0]
val_idx=fold_idx[1][1]
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=17):
        ...
        self.conv1 = nn.Conv2d(17, 64, kernel_size=3, stride=1, padding=1,
                               bias=False)
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/tooyoung/ResNet50_optionB_nogau_fold2_yous1_dehaze_30.pkl",map_location='cpu')
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[41,81], gamma=0.2)
...
for epoch in range(31,41):
    ...
    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/tooyoung/ResNet50_optionB_nogau_fold2_yous1_dehaze_"+ str(epoch)+".pkl"
