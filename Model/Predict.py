...
preda_s2_new = np.load('R2tesb_s2_new.npy')
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/tooyoung/ResNet50_optionB_nogau_fold1_yous1_dehaze_54.pkl",map_location='cpu')
...
write_csv(result.numpy().astype(int),'R2_predb_single_optionB_Res50_epoch54_fold1_0213_dehaze_yous1.csv')
