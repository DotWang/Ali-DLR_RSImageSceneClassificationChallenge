...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/single_plant_model/ResNet50_optionB_Plants_fold1_75.pkl",map_location='cpu')
...
np.save('R2_predb_single_optionB_plant_Res50_epoch75_fold1_0212_soft.npy',np.array(pred_y))
