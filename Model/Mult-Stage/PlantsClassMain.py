...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_plant_nos1_fold1')
...
fold_idx=np.load("/data/CS/Challenge/GermanAIChallenge2018/Round2/Plants_Kfold_idx.npy")
...
trn_y=trn_val_y[trn_idx]-10
val_y=trn_val_y[val_idx]-10
...
train_loader = DataLoader(dataset=train_datasets, batch_size=256, sampler=SubsetRandomSampler(range(train_new.shape[0])),num_workers=3)
valid_loader = DataLoader(dataset=valid_datasets, batch_size=256, num_workers=3)
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/single_plant_model/ResNet50_optionB_Plants_nos1_fold1_25.pkl",map_location='cpu')
...
for epoch in range(26,51):
    ...
    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/single_plant_model/ResNet50_optionB_Plants_nos1_fold1_"+ str(epoch)+".pkl"
