...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/LargeClass/ResNet50_optionB_LargeClassok_fold1_65_best.pkl",map_location='cpu')
...
np.save('R2_predb_single_optionB_Large_Res50_epoch65_fold1_0212_soft.npy',np.array(pred_y))
