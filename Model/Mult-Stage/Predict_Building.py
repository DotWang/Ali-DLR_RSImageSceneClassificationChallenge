...
preda_s1_new = np.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/R2tesb_s1_new.npy")
preda_s2_new = np.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/R2tesb_s2_new_haze.npy")
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/single_building_model/ResNet50_optionB_single_Building_fold1_90.pkl",map_location='cpu')
...
for i in tqdm(range(preda_new.shape[0])):
...
np.save('R2_predb_single_optionB_building_Res50_epoch90_fold1_0212_soft.npy',np.array(pred_y))
