...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/single_bare_model/ResNet50_optionB_Bare_fold1_50.pkl",map_location='cpu')
...
np.save('R2_predb_single_optionB_bare_Res50_epoch50_fold1_0212_soft.npy',np.array(pred_y))
