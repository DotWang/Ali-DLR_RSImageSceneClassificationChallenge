...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_nove_ve_nos1_fold1')
...
fold_idx=np.load("Building_Ve_Nove_idx.npy")
...
trn_val_y=np.load("nove_ve_y.npy")
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/NoVe_Ve/ResNet50_optionB_building_Nove_ve_nos1_fold1_70.pkl",map_location='cpu')
...
batch_idx_trn=25521
batch_idx_val=6401
for epoch in range(81,101):

    batch_idx_trn=train(epoch,batch_idx_trn)
    batch_idx_val,pred_val=valid(epoch,batch_idx_val)

    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/NoVe_Ve/ResNet50_optionB_building_Nove_ve_nos1_fold1_"+ str(epoch)+".pkl"
        torch.save(model, path)
        print("Model save to /data/DW/Challenge/GermanAIChallenge2018/scene{}.pkl".format(epoch))

writer.close()

print('训练batch',batch_idx_trn)
print('验证batch',batch_idx_val)
############################################验证集精度评价#########################################
# OA
