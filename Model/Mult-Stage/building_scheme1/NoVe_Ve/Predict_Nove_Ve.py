...
# print(label.shape)
# result=torch.zeros(len(pred_y), 2).scatter_(1, label, 1)
# write_csv(result.numpy().astype(int),'R2_preda_single_optionB_building_nove_ve_Res50_epoch45_fold5_0129.csv')
np.save('R2_preda_single_optionB_building_nove_ve_Res50_epoch70_fold1_0210_soft_nos1.npy',np.array(pred_y))
