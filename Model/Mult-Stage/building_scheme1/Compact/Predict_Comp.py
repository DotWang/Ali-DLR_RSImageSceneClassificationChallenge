...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Compact/ResNet50_optionB_building_comp_nos1_fold1_66.pkl",map_location='cpu')
...
np.save('R2_preda_single_optionB_building_comp_Res50_epoch66_fold1_0210_soft_nos1.npy',np.array(pred_y))
