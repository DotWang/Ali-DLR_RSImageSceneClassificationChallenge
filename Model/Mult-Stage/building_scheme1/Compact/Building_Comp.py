...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_comp_nos1_fold1')
...
fold_idx=np.load("Building_comp_idx.npy")
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Compact/ResNet50_optionB_building_comp_nos1_fold1_50.pkl",map_location='cpu')
...
for epoch in range(51,81):
    ...
    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Compact/ResNet50_optionB_building_comp_nos1_fold1_"+ str(epoch)+".pkl"
