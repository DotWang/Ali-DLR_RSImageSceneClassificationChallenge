...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_other_nos1_fold1')
...
fold_idx=np.load("Building_other_idx.npy")
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Other/ResNet50_optionB_building_other_nos1_fold1_40.pkl",map_location='cpu')
...
for epoch in range(41,61):
    ...
    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Other/ResNet50_optionB_building_other_nos1_fold1_"+ str(epoch)+".pkl"
