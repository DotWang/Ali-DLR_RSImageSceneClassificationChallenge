...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_comp_other_nos1_fold1')
...
fold_idx=np.load("Building_com_oth_idx.npy")
...
trn_val_y=np.load("comp_other_y.npy")
...
train_loader = DataLoader(dataset=train_datasets, batch_size=384, sampler=SubsetRandomSampler(range(train_new.shape[0])),num_workers=3)
valid_loader = DataLoader(dataset=valid_datasets, batch_size=384, num_workers=3)
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Comp_Other/ResNet50_optionB_building_comp_other_nos1_fold1_35.pkl",map_location='cpu')
...
for epoch in range(36,51):
    ...
    if epoch%3==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Comp_Other/ResNet50_optionB_building_comp_other_nos1_fold1_"+ str(epoch)+".pkl"
