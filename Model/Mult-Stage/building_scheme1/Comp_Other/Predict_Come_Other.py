...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Comp_Other/ResNet50_optionB_building_comp_other_nos1_fold1_45.pkl",map_location='cpu')
...
# write_csv(result.numpy().astype(int),'R2_preda_single_optionB_building_comp_other_Res50_epoch45_fold5_0129.csv')
np.save('R2_preda_single_optionB_building_comp_other_Res50_epoch45_fold1_0210_soft_nos1.npy',np.array(pred_y))
