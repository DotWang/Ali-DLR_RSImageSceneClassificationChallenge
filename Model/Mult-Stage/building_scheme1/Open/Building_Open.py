...
#import Accuracy
#
writer = SummaryWriter('tensorflow/single_open_nos1_fold1')
...
fold_idx=np.load("Building_open_idx.npy")
...
model=torch.load("/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Open/ResNet50_optionB_building_open_nos1_fold1_30.pkl",map_location='cpu')
...
for epoch in range(31,41):
    ...
    if epoch%5==0:
        path = "/data/DW/Challenge/GermanAIChallenge2018/Round_2/SmallClass/building_scheme1/Open/ResNet50_optionB_building_open_nos1_fold1_"+ str(epoch)+".pkl"
